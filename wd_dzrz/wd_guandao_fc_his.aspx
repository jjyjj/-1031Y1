<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wd_guandao_fc_his.aspx.cs" Inherits="MarketInfo.wd_dzrz.wd_guandao_fc_his" %>
                                                ...
                                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="input-group-addon " style="color: #00FF00; font-weight: bolder">
															<%=dt_2.Rows[i]["gd_xiaqu_gdlc"]%>
														</td>
                                                          													
														<td class="input-group-addon hidden-480"><%=dt_2.Rows[i]["gd_xiaqu_gllc"]%></td>
														<td class="input-group-addon hidden-480"><%=dt_2.Rows[i]["gd_jinri_fcgdlc"]%></td>
														<td class="input-group-addon  hidden-480">
                                                            <%=dt_2.Rows[i]["gd_jinri_fcgllc"]%></td>

														<td class="input-group-addon hidden-480">
															<%=dt_2.Rows[i]["gd_faxian_wt"]%>
														</td>

														
                                                             <td class="input-group-addon hidden-480"><%=dt_2.Rows[i]["gd_fuce_lc"]%></td>
                                                       </tr>
                                                        <% }
                                                           }%>
                                                    </tbody>
