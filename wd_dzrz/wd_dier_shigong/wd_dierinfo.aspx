<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wd_dierinfo.aspx.cs" Inherits="MarketInfo.wd_dzrz.wd_dier_shigong.wd_dierinfo" %>
                                                ...
                                                <input type="hidden" id="hide_fg" value="" />
                                                    ...
                                                    <ul>
                                                        <li>
                                                            ...
                                                            &nbsp;
                                                            <button class="btn" type="button" onclick="er_saveup('0');">
...
<script type="text/javascript">
    ...
    //修改
    function er_update(isfg, id, txtsl) {
        $('.Is_HS').hide(500);
        $('.Is_HS_Up').show(500);
