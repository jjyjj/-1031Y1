<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dier.aspx.cs" Inherits="MarketInfo.wd_dzrz.wd_dier_shigong.dier" %>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="invisible" id="main-widget-container">
                                <div class="row">
                                <h3 class="header smaller lighter blue"> <a class="btn btn-info" href="wd_dier.aspx"><i class="ace-icon fa fa-reply icon-only"></i>&nbsp;返回</a> </h3>
                                                 ...
                                                 <% if (dt_2 != null) { for (int i = 0; i < dt_2.Rows.Count; i++) {  %>
													...
													<tr>
														...
														<td class="input-group-addon">
															<a href="#"><%=dt_2.Rows[i]["er_xiangmu"]%></a>
														</td>
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover">
                                                        ...
                                                        <% if (dt_2 != null) { for (int i = 0; i < dt_2.Rows.Count; i++) {  %>
                                                            <tr>    
                                                                ...
                                                                <td class="input-group-addon"><%=dt_2.Rows[i]["er_xiangmu"]%></td> 
                                                                <td class="input-group-addon"><%=dt_2.Rows[i]["er_zydw"]%></td> 
                                                                <td class="input-group-addon"><%=dt_2.Rows[i]["er_xgdw"]%></td> 
                                                                <td class="input-group-addon"><%=dt_2.Rows[i]["er_zyqk"]%></td>
                                                                 <td class="input-group-addon"><%=dt_2.Rows[i]["er_wt"]%></td> 
                                                                <td class="input-group-addon"><%=dt_2.Rows[i]["er_gz"]%></td> 
                                                                   <td class="input-group-addon"><%=dt_2.Rows[i]["er_qt"]%></td> 
...
<script type="text/javascript">
    ...
    //由暂存转为保存
    function er_save(id) {
        mui.confirm('是否确认提交？', '提交', function (e) {
            if (e.index == 1) {
                _save(1, id);
            } else {
                mui.toast('已取消');
