<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="szff_his.aspx.cs" Inherits="MarketInfo.wd_dzrz.szff_his" %>
                                                ...
                                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tr>
														...
														<td class="input-group-addon">
															<a href="#"><%=dt_2.Rows[i]["s_xiaqu_yf"]%></a>
														</td>
														<td class="input-group-addon"><%=dt_2.Rows[i]["s_jinri_ff"]%></td>
														<td class="input-group-addon hidden-480"><%=dt_2.Rows[i]["s_jd"]%></td>
														
                                                        <td class="input-group-addon hidden-480"><%=dt_2.Rows[i]["s_bz"]%></td>
													</tr>
