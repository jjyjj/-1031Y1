<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wd_cz.aspx.cs" Inherits="MarketInfo.wd_dzrz.wd_cz" %>
...
<head>
   ...
   <%--	 <link href="../lib/assets/css/ace.min.css" rel="stylesheet" type="text/css" />--%>
		<!--[if lte IE 9]>
				...
				<ul class="nav nav-list">
					...
					<li class="">
						<a href="#" class="dropdown-toggle">
							...
							<span class="menu-text"> 业务审批</span>
					...
					<li class="">
						...
						<ul class="submenu">
							<li class="">
								<a href="javascript:void(0)" name="index.html" title="修改密码"
class="iframeurl">
									<i class="menu-icon fa fa-caret-right"></i>
									单位管理
								</a>
...
<%--
					...
					<div class="page-content">
					  ...
					  <iframe id="iframe" style="border: 0; width: 100%;height:100%; background-color: #FFF;" name="iframe"
frameborder="0" src="wd_test.aspx"></iframe>
					</div><!-- /.page-content -->
				</div>
