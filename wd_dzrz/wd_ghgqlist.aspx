<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wd_ghgqlist.aspx.cs" Inherits="MarketInfo.wd_dzrz.wd_ghgqlist" %>
                            ...
                            <div class="invisible" id="main-widget-container">
                                <div class="row">
                                    <h3 class="header smaller lighter blue">
                                        <a class="btn btn-info" href="wd_ghgq.aspx"><i class="ace-icon fa fa-reply icon-only">
                                        </i>&nbsp;返回</a>
                                    </h3>
                                                        ...
                                                        <% if (dt_2 != null)
                                                           {
                                                               ...
                                                               {  %>
                                                    <tr>
														<td class="input-group-addon center hidden-480">
															<%=i+1%>
														</td>
                                                        <%if (dt_2.Rows[i]["zid"].ToString() != "0")
                                                            {%>
                                                        <td class="input-group-addon " style="color: #00FF00; font-weight: bolder">
															<%=dt_2.Rows[i]["ghgqcode"]%>
														</td>
                                                           <% }
                                                               else {%>
                                                        <td class="input-group-addon " >
															<%=dt_2.Rows[i]["ghgqcode"]%>
                                                              ...
                                                              <% } %>														
														<td class="input-group-addon hidden-480"><%=dt_2.Rows[i]["glczmc"]%></td>
														<td class="input-group-addon hidden-480"><%=dt_2.Rows[i]["guanjin"]%></td>
														<td class="input-group-addon  hidden-480"><span class="label label-sm label-warning">
                                                            <%=dt_2.Rows[i]["dengji"]%></span></td>
														...
														<td class="input-group-addon hidden-480">
															<%=dt_2.Rows[i]["changdu"]%>
                                                             ...
                                                             <td class="input-group-addon hidden-480"><%=dt_2.Rows[i]["leixing"]%></td>
                                                        <td class="input-group-addon">
                                                            <span class="ace-icon fa fa-download bigger-50" onclick="f_huoqu('<%=dt_2.Rows[i]["gid"]%>')"></span></td>
													</tr>
                                                        <% }
                                                           }%>
                                                    </tbody>
