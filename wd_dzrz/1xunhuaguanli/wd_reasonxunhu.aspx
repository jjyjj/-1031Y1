<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wd_reasonxunhu.aspx.cs" Inherits="MarketInfo.wd_dzrz._1xunhuaguanli.wd_reasonxunhu" %>
											...
											<div class="widget-box transparent" id="widget-box-12">
												...
												<div class="widget-body">
													<div class="widget-main padding-6 no-padding-left no-padding-right">
														...
														<%-- <% if (tb != null)
                                                   {  %>
                                                          &nbsp;&nbsp; 处理人:  <%=tb.Rows[0]["t_name"]%>
                                                              <br />                                                 
                                                          &nbsp;&nbsp;审批建议:
                                                      <%=tb.Rows[0]["reason1"]%><br /><%=tb.Rows[0]["reason2"]%><br /><%=tb.Rows[0]["reason3"]%>
