<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wd_fangxungl_his.aspx.cs" Inherits="MarketInfo.wd_dzrz.wd_fangxungl_his" %>
                                                ...
                                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="input-group-addon " style="color: #00FF00; font-weight: bolder">
															<%=dt_2.Rows[i]["fx_xingzhengweizhi"]%>
														</td>                                                          													
														<td class="input-group-addon hidden-480"><%=dt_2.Rows[i]["fx_leixing"]%></td>
														<td class="input-group-addon hidden-480"><%=dt_2.Rows[i]["fx_zhongdianbuwei"]%></td>
														<td class="input-group-addon  hidden-480">
                                                            <%=dt_2.Rows[i]["fx_xxglryxxjg"]%></td>

														<td class="input-group-addon hidden-480">
															<%=dt_2.Rows[i]["fx_sswh"]%>
														</td>                                                        														
                                                             <td class="input-group-addon hidden-480"><%=dt_2.Rows[i]["fx_qtbz"]%></td>
                                                       </tr>
                                                        <% }
                                                           }%>
                                                    </tbody>
