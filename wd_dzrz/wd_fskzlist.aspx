<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wd_fskzlist.aspx.cs" Inherits="MarketInfo.wd_dzrz.wd_fskzlist" %>
                            ...
                            <div class="invisible" id="main-widget-container">
                                <div class="row">
                                    <h3 class="header smaller lighter blue">
                                        <a class="btn btn-info" href="wd_fushikz.aspx"><i class="ace-icon fa fa-reply icon-only"></i>&nbsp;返回</a>
                                        <a class="btn btn-info" href="wd_fushikz_his.aspx"><i class="ace-icon fa fa-reply icon-only"></i>&nbsp;历史记录</a>
                                                    ...
                                                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="input-group-addon">桩号
                                                                </th>
                                                                <th class="input-group-addon ">行政位置
                                                                </th>
                                                                <th class="input-group-addon hidden-480">故障处理
                                                                </th>
                                                                <th class="input-group-addon hidden-480">定期测试
                                                                </th>
                                                                <th class="input-group-addon hidden-480">设备参数调整
                                                                </th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="input-group-addon">
                                                                    <a href="#"><%=dt_2.Rows[i]["fs_zhuanghao"]%></a>
                                                                </td>
