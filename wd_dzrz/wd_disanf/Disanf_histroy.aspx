<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Disanf_histroy.aspx.cs" Inherits="MarketInfo.wd_dzrz.wd_disanf.Disanf_histroy" %>
                ...
                <div class="page-content">
                    <div class="row">
                        <div class="col-xs-12">
                           ...
                           <input type="hidden" id="Hidtid" value=""  runat="server"/>
                            <!-- 新增施工 -->
                            <div class="row">
                                        ...
                                        <div class="widget-box widget-color-blue"   >
                                            <div class="widget-header">
                                                <h5 class="widget-title bigger lighter">
                                                    <span style="color: #FFFFFF; font-weight: bolder;"><i class="ace-icon fa fa-table"></i>历史记录</span>
                                                </h5>
                                            </div>
                                ...
                                <h3 class="header smaller lighter blue"> <a class="btn btn-info" href="../wd_ywsb.aspx"><i class="ace-icon fa fa-reply icon-only"></i>&nbsp;返回</a>
                                 ...
                                 <div class="col-xs-12 col-sm-6 widget-container-col Is_Hilist auto_list">
                                        <div class="widget-box widget-color-blue"   >
                                            <div class="widget-header">
                                                <h5 class="widget-title bigger lighter">
                                                    <span style="color: #FFFFFF; font-weight: bolder;"><i class="ace-icon fa fa-table"></i>历史列表</span>
                                                </h5>
                                            </div>
                                            <div class="widget-body">
                                                <div class="widget-main no-padding">
...
<script src="disanf_his.js" type="text/javascript"></script>
<script type="text/javascript">
    $(function () {
        $('.Is_HS').hide();
