...
namespace MarketInfo.wd_dzrz.wd_disanf.his_it
{
    ...
    /// selxzsg_his 的摘要说明
    /// </summary>
    public class selxzsg_his : IHttpHandler, IRequiresSessionState 
    {
        ...
        {         
            ...
            string StrSql = "select  * from dbo.T_Dsan_xinzengshigong where t_id='" + strtid + "' and sp1='1' and spid1<>'0'   order by id desc";
            if (!string.IsNullOrWhiteSpace(strid)) {
                StrSql = "select  * from dbo.T_Dsan_xinzengshigong where t_id= '" + strtid + "' and sp1='1' and spid1<>'0'  and id=" + strid;
            }
            try
            {
