...
namespace MarketInfo.wd_dzrz.wd_disanf.his_it
{
    ...
    /// seldsfsg_his 的摘要说明
    /// </summary>
    public class seldsfsg_his : IHttpHandler, IRequiresSessionState 
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string StrSql = "select  * from dbo.T_Dsan_shigong where t_id='" + strtid + "'and sp1='1' and spid1<>'0'   order by id desc";
            if (!string.IsNullOrWhiteSpace(strid))
            {
                StrSql = "select  * from dbo.T_Dsan_shigong where t_id='" + strtid + "'and sp1='1' and spid1<>'0'   and id=" + strid;
            }
            try
            {
