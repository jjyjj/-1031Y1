<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wd_ziliao.aspx.cs" Inherits="MarketInfo.wd_dzrz.wd_ziliao" %>
		...
		<div class="main-container ace-save-state" id="main-container">
												...
												<div class="widget-body">
													<div class="widget-main">
                                                        ...
                                                        <label for="form-field-mask-2">
                                                            ...
                                                            <div>
															<textarea class="form-control limited"  maxlength="50" placeholder="若没有请输入无" runat="server" id="ziliao_bz"></textarea>
														</div>								
         ...
         %>
                                                                ...
                                                                <td width="50" class="input-group-addon"><%=i+1 %></td>
																	<td class="input-group-addon"><%=tb.Rows[i]["z_bz"]%></td>
         ...
         %>
																<tr>
                                                                <td width="50" class="input-group-addon"><%=i+1%></td>
																	<td class="input-group-addon"><%=tbzc.Rows[i]["z_bz"]%></td>
                                                                    ...
                                                                    <span class="label label-success arrowed-in arrowed-in-right"><%=tbzc.Rows[i]["s_bz"]%></span>
                                                                     ...
                                                                     <td class="input-group-addon"> 
												                          <span onclick="f_post('<%=tbzc.Rows[i]["z_bz"]%>','<%=tbzc.Rows[i]["z_id"]%>');"> <i class="ace-icon glyphicon glyphicon-upload"></i>
												                          </span>											                         
    ...
    <script src="js/mui.min.js" type="text/javascript"></script>
      ...
      <script type="text/javascript" charset="utf-8">
          ...
          function f_fsubmint(type) {
              // mui.toast(type);
              var ziliao_bz = $("#ziliao_bz").val();
              if (ziliao_bz == "") {
                  mui.toast("请填写资料整理的备注!");
                  return;
              }
              
              $.post("../it/it_post.aspx?CMD=CURTZLZL&FLAG=" + type + "&ZBZ=" +
         ziliao_bz, {}, function (data) {
          ...
          function f_set(gid) {
              var url = "../it/it_post.aspx?CMD=ZLPOST&EDIT_ZLID=" + gid;
