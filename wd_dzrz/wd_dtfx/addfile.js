...
function add(istype) {
    if (istype == "1") { $('.Is_HS').show(500); } else { $('.Is_HS1').show(500); }
...
function DataBind(data, tb) {
    ...
    for (var p in data) {
        ...
        td1 = '<td class="input-group-addon">' + (parseInt(p) + 1) + '</td><td class="input-group-addon"><a onclick="f_OpenDlg(\'' + data[p].id + '\',\'A\')">' + data[p].title + '</a></td><td class="input-group-addon">' + IS_type(data[p].file_type) + '</td>';
...
function DataBind1(data, tb) {
    ...
    for (var p in data) {
        ...
        td1 = '<td class="input-group-addon">' + (parseInt(p) + 1) + '</td><td class="input-group-addon"><a onclick="f_OpenDlg(\'' + data[p].id + '\',\'B\')">' + data[p].title + '</a></td>';
        tr += '<tr>' + td1 + td2 + '<td class="input-group-addon">' + xiangqing + '</td></tr>';
    }
    $('#' + tb + ' tbody').append(tr);
}
