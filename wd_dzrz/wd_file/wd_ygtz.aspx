<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wd_ygtz.aspx.cs" Inherits="MarketInfo.wd_dzrz.wd_file.wd_ygtz" %>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="invisible" id="main-widget-container">
                                ...
                                <a class="btn btn-info xxwj_hide1" href="javascript:;" onclick="add('2')"><i class="ace-icon"></i>&nbsp;新增有关通知</a> 
                                 </h3>                                   
                                        ...
                                        <div class="widget-box widget-color-blue" >
                                            <div class="widget-header">
                                                <h5 class="widget-title bigger lighter">
                                                    <span style="color: #FFFFFF; font-weight: bolder;"><i class="ace-icon fa fa-table"></i>有关通知</span>
                                                </h5>
                                            </div>
                                    ...
                                    <div class="col-xs-12 col-sm-4 Is_HS1 auto_add" style=" display:none;">
                                        <div class="widget-box">
                                            <div class="widget-header">
                                                ...
                                                <a href="#"  onclick="closes1()" title="关闭"><i class="ace-icon fa fa-close"></i></a>
                                                </span>
                                            </div>
                                            <div class="widget-body">
                                                <div class="widget-main">
                                                        <div><div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control input-mask-phone" name="txtTitle" id="txttitle1" placeholder="请输入" autocomplete="off"  runat="server"/>
                                                        </div></div> &nbsp;  
                                                    <div class="col-sm-12">
                                                    ...
                                                    <asp:Button ID="btn_save1" Text="保存" runat="server"  oncommand="btn_save1_Command"  />                                                     
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
