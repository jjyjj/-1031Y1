<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="spjkxx.aspx.cs" Inherits="MarketInfo.wd_dzrz.spjkxx" %>
                                                ...
                                                <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                    ...
                                                    <tr>
														<td class="input-group-addon center">
															<%=dt_2.Rows[i]["s_zhanming"]%>
														</td>

														<td class="input-group-addon">
															<a href="#"><%=dt_2.Rows[i]["s_anzhuangwz"]%></a>
														</td>
														<td class="input-group-addon"><%=dt_2.Rows[i]["s_xmgcqc"]%></td>
														<td class="input-group-addon hidden-480"><%=dt_2.Rows[i]["s_shifouzc"]%></td>
														<td class="input-group-addon"><%=dt_2.Rows[i]["s_uid"]%></td>

														<td class="input-group-addon hidden-480">
															<span class="label label-sm label-warning"><%=dt_2.Rows[i]["s_pzdw"]%></span>
														</td>

														<td class="input-group-addon  hidden-480">
															<%=dt_2.Rows[i]["s_beizhu"]%></td>
                                                             <td class="input-group-addon"><%=dt_2.Rows[i]["s_whqk"]%></td>
													</tr>
