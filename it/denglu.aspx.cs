...
namespace MarketInfo.it
{
    public partial class denglu : System.Web.UI.Page
    {
        ...
        {
            if (Request.QueryString["UNAME"].ToString() != null && Request.QueryString["UPWD"].ToString() != null)
            {
                string my_Uname = Request.QueryString["UNAME"].ToString().Trim();
                string my_PWD = Request.QueryString["UPWD"].ToString().Trim();
                Islogin();
        ...
        {            
            ...
            String strSQL = "Select * from T_USER_INFO where T_UNAME='" + Request.QueryString["UNAME"]
                + "' and T_PWD='" + Request.QueryString["UPWD"] + "'";
            ...
            if (tb != null)
            {
                ...
                Response.Write("YES");//成功
               // return;

            }
            else
            {
                Response.Write("NO");//失败
               // return;
