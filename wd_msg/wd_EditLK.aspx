<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wd_EditLK.aspx.cs" Inherits="MarketInfo.ZSGLInfo.wd_EditLK" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function getAllHtml() {
            ...
            document.getElementById("<%=HiddenField1.ClientID %>").value = UE.getEditor('editor').getContent();
            document.getElementById("<%=HiddenField2.ClientID %>").value = UE.getEditor('editor').getContentTxt();
