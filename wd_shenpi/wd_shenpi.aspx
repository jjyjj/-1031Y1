<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wd_shenpi.aspx.cs" Inherits="MarketInfo.wd_shenpi.wd_shenpi" %>
										...
										<div id="faq-tab-3"  class="tab-pane fade in active">											
											...
											<div id="faq-list-3" class="panel-group accordion-style1 accordion-style2">
                                                ...
                                                <i class="ace-icon fa  fa-square   fa-hand-paper-o bigger-230"></i>		
                                                    <span class="badge badge-pink kaiwa" id="kaiwanum"></span>																				
												</a>
                                                ...
                                                <i class="ace-icon fa  fa-chanzi bigger-230"></i>	
                                                     <span class="badge badge-pink DIER" id="diernum"></span>																							
												</a>
    ...
    <script type="text/javascript" src ="js/count.js"></script>
        ...
        <script type="text/javascript">
            ...
            function f_WJ() {
                var tid = $("#hide_tid").val();
                //alert(tid);
                location.href = "kwzy.aspx?TID=" + tid;

            }
            function f_SG() {
                var tid = $("#hide_tid").val();
                //alert(tid);
                location.href = "erSG.aspx?TID=" + tid;
            ...
            function f_FS() {
                var tid = $("#hide_tid").val();
                //alert(tid);
                location.href = "FSKZ.aspx?TID=" + tid;
