...
namespace MarketInfo.wd_shenpi.it_sp
{
    ...
    /// sp_dier 的摘要说明
    /// </summary>
    public class sp_dier : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            {
                StrSql = "select count(*) as num from dbo.t_DIER_shigong where ntype='3' and zpid='" + strzid + "' and flag='1' and sp1='0' and spid1='0' and DateDiff(dd,setTime ,getdate())=0 ";
            ...
            if (strtpe == "1")//区主任
            {
                ...
                StrSql = "select  count(*) as num from t_DIER_shigong where flag='1' and sp1='1' and spid1<>'0' and sp2='0' and spid2='0' and DateDiff(dd,setTime ,getdate())=0 " + where;
