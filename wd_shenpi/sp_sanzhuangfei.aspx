<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sp_sanzhuangfei.aspx.cs" Inherits="MarketInfo.wd_shenpi.sp_sanzhuangfei" %>
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="page-header">
                         ...
                         <a class="btn btn-info" href="../wd_dzrz/szff_his.aspx?UTID=<%=UTID%>">
                          &nbsp;历史记录</a>
                        </h3>
						<div class="row">
							<div class="col-xs-12">
											...
											<thead>
												<tr>
												 ...
												 <th class="input-group-addon">序号</th>
                                                   <th class="input-group-addon hidden-480">场站</th>
                                                <th class="input-group-addon">姓名</th>
													<th class="input-group-addon hidden-480">实发金额</th>
													<th class="input-group-addon hidden-480">应发金额</th>
                                            ...
                                            <%if (tb != null)
												...
												<tr>
                                                   ...
                                                   <td class="input-group-addon"><%=i+1%></td>
                                                     <td class="input-group-addon hidden-480"><%=tb.Rows[i]["dwname"]%></td>  
                                                   <td class="input-group-addon"><%=tb.Rows[i]["truename"]%></td>
													
													<td class="input-group-addon hidden-480">
														<%=tb.Rows[i]["s_xiaqu_yf"] %>
													</td>
													<td class="input-group-addon hidden-480"><%=tb.Rows[i]["s_jinri_ff"]%></td>
													
													<td class="input-group-addon"><span class="label label-sm label-warning"><%=tb.Rows[i]["s_jd"] %></span></td>
													<td class="input-group-addon Hide_types">
																<span onclick="f_shenpi('<%=tb.Rows[i]["s_id"]%>','-1')"><i class="ace-icon fa fa-flag bigger-120 btn btn-xs btn-danger"></i></span> 
...
//                var url = "../it/it_shenpi.aspx?CMD=SZFSP&TYPE=" + type + "&EDIT_SZID=" + id;
            ...
            function f_UpTitle(id, type) {
                ...
                layer.open({
                    ...
                    , yes: function (index, layero) {
                        ...
                        //}
                        var Hide_Sp = $('#Hide_Sp').val();
//                        $.post("../it/erSG.ashx", { TYPE: type, ID: id, sp: Hide_Sp, Reason: txtReason }, function (data) {
//                            if (data == "1") {
//                                mui.toast("审批成功!");
//                                location.reload();
//                            }
...
//                        });
                        ...
                        var url = "../it/it_shenpi.aspx?CMD=SZFSP&TYPE=" + type + "&Reason=" + txtReason + "&EDIT_SZID=" + id;
                        $.post(url, {}, function (data) {
                            if (data == "1") {
                                mui.toast("操作成功!");
                                location.reload();
