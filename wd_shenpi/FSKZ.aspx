         <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FSKZ.aspx.cs" Inherits="MarketInfo.wd_shenpi.FSKZ" %>
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
                        ...
                        <h3 class="header smaller lighter blue"> <a class="btn btn-info" onclick="go_shenpi()"><i class="ace-icon fa fa-reply icon-only"></i>&nbsp;返回</a>
                         <a class="btn btn-info" href="../wd_dzrz/wd_fushikz_his.aspx?UTID=<%=UTID%>">
                          &nbsp;历史记录</a>
                        </h3>
						<div class="row">
							<div class="col-xs-12">
											...
											<thead>
												<tr> 
                                                   <th class="input-group-addon"><i class="ace-icon fa fa-flag"></i>序号</th>
													<th class="input-group-addon">故障处理</th>
													<th class="input-group-addon">设备/参数调整</th> 
                                            ...
                                            <%if (tb != null)
												...
												<tr>
													...
													<td class="input-group-addon">
														<a href="#"><%=tb.Rows[i]["fs_guzhang_cl"]%></a>
													</td>
													<td class="input-group-addon"><%=tb.Rows[i]["fs_shebei_tz"]%></td>
													
													<td class="input-group-addon  hidden-480"> <%=tb.Rows[i]["fs_dingqi_cs"]%> </td>


                                                    <td class="input-group-addon hidden-480"> <%=tb.Rows[i]["fs_bz"]%> </td>
													...
													<td class="input-group-addon Hide_types">
														<div class="hidden-sm hidden-xs btn-group">															
															<button class="btn btn-xs btn-danger">
																<span onclick="f_shenpi('<%=tb.Rows[i]["fs_id"]%>','-1')"><i class="ace-icon fa fa-flag bigger-120"></i></span>
															</button>
														</div>
														<div class="hidden-md hidden-lg">
															<div class="inline pos-rel">
																...
																<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																	<li>
																		<a href="#" class="tooltip-info"  onclick="f_shenpi('<%=tb.Rows[i]["fs_id"]%>','-1')" data-rel="tooltip" title="View">
																			<button class="btn btn-xs btn-danger">
																<span onclick="f_shenpi('<%=tb.Rows[i]["fs_id"]%>','-1')"><i class="ace-icon fa fa-flag bigger-120"></i></span>
															</button>
																		</a>
...
//                $.post("../it/FSSP.ashx", { TYPE: type, ID: id, sp: Hide_Sp }, function (data) {
//                    if (data == "1") {
//                        mui.toast("审批成功!");
//                        location.reload();
//                    }
            ...
            function f_UpTitle(id, type) {
                ...
                layer.open({
                    ...
                    , yes: function (index, layero) {
                        ...
                        //}
                        var Hide_Sp = $('#Hide_Sp').val();
                        $.post("../it/FSSP.ashx", { TYPE: type, ID: id, sp: Hide_Sp, Reason: txtReason }, function (data) {
                            if (data == "1") {
                                mui.toast("审批成功!");
                                location.reload();
                            }
