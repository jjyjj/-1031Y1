...
{
    public partial class FSKZ : System.Web.UI.Page
    {
        ...
        //    //String strtid = Session["CUR_TID"].ToString(); 
        //    String strtid = Request.QueryString["TID"].ToString();
        //    String Sql = "";
        //    if (strtpe == "2")
        //    {
        //        Sql = "select * from t_fushi where fs_tid='" + strtid + "' and flag='1' and sp1='0' and spid1='0' and DateDiff(dd,fs_time ,getdate())=0 ";
        ...
        protected void type2(string strtid)
        {
            ...
            string StrSql = "select * from dbo.t_fushi where fs_tid in (" + data_zid + ")and  flag='1' and sp1='0' and DateDiff(dd,fs_time ,getdate())=0 ";
        ...
        protected void type1(string strtid)
        {
            ...
            string StrSql = "select * from dbo.t_fushi  where fs_tid in (" + data_zid + ")   and sp1='1' and sp2='0' and spid2='0' and  flag='1'   and DateDiff(dd,fs_time ,getdate())=0 ";
            tb = WXDBUtility.SqlHelper.GetDataTable(StrSql);
        }
        protected void type0(string strtid)
        {
            ...
            string StrSql = "select * from dbo.t_fushi  where fs_tid in (" + data_zid + ")   and sp2='1' and spid2<>'0' and  flag='1'   and DateDiff(dd,fs_time ,getdate())=0 ";
            tb = WXDBUtility.SqlHelper.GetDataTable(StrSql);
        }
