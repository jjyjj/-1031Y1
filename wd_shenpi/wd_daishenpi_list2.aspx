<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wd_daishenpi_list2.aspx.cs" Inherits="MarketInfo.wd_shenpi.wd_daishenpi_list2" %>
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div class="main-content">
				<div class="main-content-inner">			
                    ...
                    <a class="btn btn-info btn-sm tooltip-info" data-rel="tooltip" data-placement="bottom" title="" data-original-title="Bottm Info" href="wd_daishenpi_list.aspx">返回</a>
															...
															<thead class="thin-border-bottom">
                                                                ...
                                                                <th  class="input-group-addon">																	
                                                                    序号
                                                                     ...
                                                                     <th  class="input-group-addon">  <i class="ace-icon fa fa-flag"></i>
                                                                     单位名称</th>
																	<th  class="input-group-addon">																	
                                                                    ...
                                                                    <th  class="input-group-addon">职务</th>   
                                                                      <th  class="input-group-addon">查看日志</th>                                                              
																</tr>
															</thead>
                                                             ...
                                                             <%if (tb != null)
                                                               ...
                                                               <tr>
                                                                <td  class="input-group-addon"><%=i+1%></td>
                                                                    ...
                                                                    <%--<%if (tb.Rows[i]["type"].ToString() == "3" || tb.Rows[i]["type"].ToString() == "2")
                                                                      { %>--%>
                                                                      
                                                                      <%=tb.Rows[i]["dwname"]%>
                                                                   <%--  <% }
                                                                     else { %>--%>
                                                                      <%--<a href="wd_daishenpi_list2.aspx?CURTID=<%=tb.Rows[i]["ZID"] %>"><%=tb.Rows[i]["dwname"]%></a>
                                                                    --%>
                                                                    <%--  <%} %>--%>
                                                                    ...
                                                                    <%if (tb.Rows[i]["type"].ToString() == "3" || tb.Rows[i]["type"].ToString() == "2")
                                                                      { %>
                                                                       <a href="wd_shenpi.aspx?TID=<%=tb.Rows[i]["T_ID"]%>" alt="<%=tb.Rows[i]["T_ID"]%>"> <i class="ace-icon glyphicon glyphicon-th"></i>	 </a>																
                                                                      
                                                                    <%  }
                                                                      else { %>
                                                                       <a href="../wd_dzrz/wd_gdkwork/wd_hiswork.aspx?UTID=<%=tb.Rows[i]["T_ID"]%>" alt="<%=tb.Rows[i]["T_ID"]%>"> <i class="ace-icon glyphicon glyphicon-th"></i>	 </a>																
