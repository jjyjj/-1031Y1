<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="erSG.aspx.cs" Inherits="MarketInfo.wd_shenpi.erSG" %>
				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="page-header">
                         ...
                         <a class="btn btn-info" href="../wd_dzrz/wd_dier_shigong/dier_hislist.aspx?UTID=<%=UTID%>">
                          &nbsp;历史记录</a>
                        </h3>
						<div class="row">
							<div class="col-xs-12">
											...
											<thead>
												<tr>
												 ...
												 <th class="input-group-addon"><i class="ace-icon fa fa-flag"></i>序号</th>
													...
													<th class="input-group-addon  hidden-480">作业单位</th>
													...
													<th class="input-group-addon">当日作业情况</th>
												...
												<tr>
                                                   ...
                                                   <td class="input-group-addon"><%=i+1%></td>
													<td class="input-group-addon">
														<a href="#"><%=tb.Rows[i]["er_xiangmu"]%></a>
													</td>
													<td class="input-group-addon  hidden-480"><%=tb.Rows[i]["er_zydw"]%></td>
													
													<td class="input-group-addon  hidden-480"><%=tb.Rows[i]["er_xgdw"]%></td>


                                                    <td class="input-group-addon"><%=tb.Rows[i]["er_zyqk"]%></td>
                                                    <td class="input-group-addon hidden-480"><%=tb.Rows[i]["er_wt"]%></td>
                                                    <td class="input-group-addon hidden-480"><%=tb.Rows[i]["er_gz"]%></td>
                                                    <td class="input-group-addon  hidden-480"><%=tb.Rows[i]["er_qt"]%></td>
...
//                $.post("../it/erSG.ashx", { TYPE: type, ID: id, sp: Hide_Sp }, function (data) {
//                    if (data == "1") {
//                        mui.toast("审批成功!");
//                        location.reload();
//                    }
