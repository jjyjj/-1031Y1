...
namespace MarketInfo.wd_shenpi.itface
{
    ...
    /// dier 的摘要说明
    /// </summary>
    public class dier : IHttpHandler, IRequiresSessionState
    {
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (strtpe == "2")
            {
                ...
                StrSql = "select count(*) as num from dbo.t_DIER_shigong where t_id='" + strtid + "' and  flag='1' and sp1='0'and spid1='0' and DateDiff(dd,er_time ,getdate())=0 ";
            ...
            if (strtpe == "1")
            {
               ...
               //   StrSql = "select * from dbo.t_DIER_shigong  where t_id in (" + data_zid + ")   and sp1='1' and sp2='0' and spid2='0' and  flag='1'   and DateDiff(dd,er_time ,getdate())=0 ";
                StrSql = "select  count(*) as num from t_DIER_shigong where t_id='" + context.Request.Form["tid"] + "' and sp1='1' and sp2='0'  and spid2='0' and  flag='1' and DateDiff(dd,er_time ,getdate())=0 ";
