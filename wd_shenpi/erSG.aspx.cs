...
{
    public partial class erSG : System.Web.UI.Page
    {
        ...
        protected void type2(string strtid) {
            ...
            string StrSql = "select * from dbo.t_DIER_shigong where t_id in (" + data_zid + ")and  flag='1' and sp1='0' and DateDiff(dd,er_time ,getdate())=0 ";
        ...
        protected void type1(string strtid)
        {
            ...
            string StrSql = "select * from dbo.t_DIER_shigong  where t_id in (" + data_zid + ")   and sp1='1' and sp2='0' and spid2='0' and  flag='1'   and DateDiff(dd,er_time ,getdate())=0 ";
            tb = WXDBUtility.SqlHelper.GetDataTable(StrSql);    
        }
        protected void type0(string strtid)
        {
            ...
            string StrSql = "select * from dbo.t_DIER_shigong  where t_id in (" + data_zid + ")   and sp2='1' and spid2<>'0' and  flag='1'   and DateDiff(dd,er_time ,getdate())=0 ";
            tb = WXDBUtility.SqlHelper.GetDataTable(StrSql); 
        }
