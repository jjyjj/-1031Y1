...
{
    public partial class XunHuGuanLi : System.Web.UI.Page
    {
        ...
        protected void type2(string strtid)
        {
            ...
            string StrSql = "select * from dbo.t_xunhuguanli where xh_tid in (" + data_zid + ")and  flag='1' and sp1='0' and DateDiff(dd,xh_time ,getdate())=0 ";
        ...
        protected void type1(string strtid)
        {
            ...
            data_zid += strtid; 
            string StrSql = "select * from dbo.t_xunhuguanli  where xh_tid in (" + data_zid + ")   and sp1='1' and sp2='0' and sprid2='0' and  flag='1'   and DateDiff(dd,xh_time ,getdate())=0 ";
            tb = WXDBUtility.SqlHelper.GetDataTable(StrSql);
        }
        protected void type0(string strtid)
        {
            ...
            string StrSql = "select * from dbo.t_xunhuguanli  where xh_tid in (" + data_zid + ")   and sp2='1' and sprid2<>'0' and  flag='1'   and DateDiff(dd,xh_time ,getdate())=0 ";
            tb = WXDBUtility.SqlHelper.GetDataTable(StrSql);
        }
        #endregion
        ...
        public void _BindData()
        {
            ...
            if (strtpe == "2")
            {
                String strSel1 = "select *   from t_xunhuguanli where xh_tid='" + strtid + "'and flag='1' and sp1='0' and sprid1='0' and DateDiff(dd,xh_time ,getdate())=0 ";
