...
namespace MarketInfo.wd_shenpi
{
    ...
    { 
        ...
        protected void type2(string strtid)
        {
            ...
            string StrSql = "select * from dbo.t_qita where q_tid in (" + data_zid + ")and  flag='1' and sp1='0' and DateDiff(dd,q_time ,getdate())=0 ";
        ...
        protected void type1(string strtid)
        {
            ...
            string StrSql = "select * from dbo.t_qita  where q_tid in (" + data_zid + ")   and sp1='1' and sp2='0' and sprid2='0' and  flag='1'   and DateDiff(dd,q_time ,getdate())=0 ";
            tb = WXDBUtility.SqlHelper.GetDataTable(StrSql);
        }
        protected void type0(string strtid)
        {
            ...
            string StrSql = "select * from dbo.t_qita  where q_tid in (" + data_zid + ")   and sp2='1' and sprid2<>'0' and  flag='1'   and DateDiff(dd,q_time ,getdate())=0 ";
            tb = WXDBUtility.SqlHelper.GetDataTable(StrSql);
        }
        #endregion
        public void _BindData()
        {
            ...
            if (strtpe == "2")
            {
                Sql = "select *   from t_qita where q_tid='" + strtid + "' and flag='1' and sp1='0' and sprid1='0' and DateDiff(dd,q_time ,getdate())=0 ";
