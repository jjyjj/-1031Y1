<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wd_daishenpi_list.aspx.cs" Inherits="MarketInfo.wd_shenpi.wd_daishenpi_list" %>
														...
														<table class="table table-striped table-bordered table-hover">
															<thead class="thin-border-bottom">
                                                                ...
                                                                <th  class="input-group-addon">																	
                                                                    ...
                                                                    <th  class="input-group-addon hidden-480">职务</th>   
                                                             ...
                                                             <%if (tb != null)
                                                               ...
                                                               <tr>
                                                                <td  class="input-group-addon"><%=i+1%></td>
                                                                    ...
                                                                    <%if (tb.Rows[i]["type"].ToString() == "3")
                                                                      { %>
                                                                       <a href="wd_shenpi.aspx?TID=<%=tb.Rows[i]["T_ID"]%>"alt="<%=tb.Rows[i]["T_ID"]%>"> <i class="ace-icon glyphicon glyphicon-th"></i>
                                                                       	 </a>
                                                                     <% }
                                                                      else { %>                                                                      
                                                                      <a href="wd_daishenpi_list2.aspx?DWNAME=<%=tb.Rows[i]["dwname"]%>&CURTID=<%=tb.Rows[i]["ZID"] %>" alt="<%=tb.Rows[i]["ZID"]%>"> <i class="ace-icon glyphicon glyphicon-th"></i>
                                                                       	 </a>
                                                                      <%}%>															
																	</td>	
                                                                    <%}
