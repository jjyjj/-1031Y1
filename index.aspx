...
<style type="text/css">
li.open ul.submenu li.home{ height:35.8px !important;}
...
<li class="light-blue"><a data-toggle="dropdown" href="#" class="dropdown-toggle"> <span class="user-info"><small>欢迎您,</small><asp:Label ID="m_curuser" runat="server" Text=""></asp:Label></span> <i class="icon-caret-down">
</i></a>
...
业务 </span><b class="arrow icon-angle-down"></b></a>
<ul class="submenu">--%>
...
title="单位变更">        
        <i class="icon-tag pink2"></i>
        <span class="menu-text">单位变更 </span></a></li>
