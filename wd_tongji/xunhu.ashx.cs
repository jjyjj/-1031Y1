...
namespace MarketInfo.wd_tongji
{
    ...
    /// xunhu 的摘要说明
    /// </summary>
    public class xunhu : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (strtype == "2")//站长
            {
                ...
                StrSql = "select  count(1) as num from dbo.t_xunhuguanli where " + where + " and sp1='0' and DateDiff(dd,xh_time ,getdate())=0";
            ...
            if (strtype == "1")//区主任
            {
                ...
                StrSql = "select  count(1) as num from t_xunhuguanli where " + where + " and sp1='1' and sp2='0' and DateDiff(dd,xh_time ,getdate())=0";

                //  where = " g_tid IN ( " + tid + ") ";
                //}
                //StrSql = "select  count(1) as num from dbo.t_ghgq_info where " + where + " and sp1='0' and DateDiff(dd,g_time ,getdate())=0";
            ...
            if (strtype == "0")//区主任
            {
                ...
                StrSql = "select  count(1) as num from t_xunhuguanli where  sp1='1' and sp2='1' and DateDiff(dd,xh_time ,getdate())=0";
            }
            if (strtype == "3")//线路管理员
            {
