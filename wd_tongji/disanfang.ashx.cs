...
namespace MarketInfo.wd_tongji
{
    ...
    /// disanfang 的摘要说明
    /// </summary>
    public class disanfang : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (strtype == "2")//站长
            {
                ...
                StrSql = "select  count(1) as num from T_Dsan_shigong where " + where + " and sp1='0' and DateDiff(dd,setTime ,getdate())=0";
            ...
            if (strtype == "1")//区主任
            {
                ...
                StrSql = "select  count(1) as num from T_Dsan_shigong where " + where + " and sp1='1' and sp2='0' and DateDiff(dd,setTime ,getdate())=0";

            }
            if (strtype == "0")//区主任
            {

                StrSql = "select  count(1) as num from T_Dsan_shigong where  sp1='1' and sp2='1' and DateDiff(dd,setTime ,getdate())=0";
            }
            if (strtype == "3")//线路管理员
            {
