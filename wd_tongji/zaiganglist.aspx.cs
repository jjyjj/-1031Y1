...
{
    public partial class zaiganglist : System.Web.UI.Page
    {
       public DataTable tb = null;
        ...
        public void BindData() {
            ...
            if (strtype == "2")//站长
            {
                ...
                StrSql = "select  a.*,b.T_NAME,b.T_ID ,c.zname as dw from dbo.t_log a,T_USER_INFO b,T_ZYQ_INFO  c where " + where + "  and DateDiff(dd,a.trctime ,getdate())=0 and c.zid=a.ZID and a.flag='1' and a.write='1'";
            ...
            if (strtype == "0")//管理处
            {
                StrSql = "select a.* ,b.T_NAME,b.T_ID ,c.zname as dw from dbo.t_log a, T_USER_INFO b,T_ZYQ_INFO c where  DateDiff(dd,a.trctime ,getdate())=0 and a.T_ID=b.T_ID and c.zid=a.zid and a.flag='1' and a.write='1'";
            }
            if (strtype == "3")//线路管理员
            {
