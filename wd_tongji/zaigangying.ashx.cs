...
namespace MarketInfo.wd_tongji
{
    ...
    /// zaigangying 的摘要说明
    /// </summary>
    public class zaigangying : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (strtype == "2")//站长
            {
                ...
                StrSql = "select  count(*) as num from dbo.T_USER_INFO where " + where + "";
            ...
            if (strtype == "0")//管理处
            {
                ...
                StrSql = "select  count(*) as num from dbo.T_USER_INFO";
            }
            if (strtype == "3")//线路管理员
            {
